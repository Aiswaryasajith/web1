...
<body>
   <div class="container">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <li><a class="dropdown-item" href="#">System Adminstration</a></li>
       ...
       <div class="row">
           <div class="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6"><div class="card" style="width: 38rem;">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPqug4XC9If5F6LkXSiqL9AoFfEUpvM3BV9Q&usqp=CAU" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text">Programme Outcome (PO)
                ...
                PO12: Innovation and Entrepreneurship: Identify a timely opportunity and using innovation to pursue that opportunity to create value and wealth for the betterment of the individual and society at large.</p>
            </div>
          </div></div>
           <div class="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6"><div class="card" style="width: 38rem;">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQj47KniNKL2WfhJOYI2EOT4rtjZSZefUbQVA&usqp=CAU" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text">he Two-year Master’s Degree Programme in Computer Science (Data Analytics) is introduced under the Department of Computer Science, Rajagiri College of Social Sciences in 2020 to meet the growing demand for well qualified and trained Data Analysts in the Industry. The course is affiliated to Mahatma Gandhi University, Kottayam, Kerala, India. The annual intake of students to the course is Thirty. The students are admitted to the course through careful screening and other admission criteria.
                The MSc Computer Science (Data Analytics) programme offered by Rajagiri College will provide the graduates of computer science with the essential requirements that are needed in the field of Data Science. </p>
            </div>
          </div></div>
       </div>
   </div> 
